...
class Alg_WC_MPPU_Core {
	...
	function get_first_order_date_exp( $first_order_date, $date_range, $do_timeleft = false ) {
		...
		if ( false !== $first_order_date ) {
			...
			return apply_filters( 'alg_wc_mppu_get_first_order_date_exp', ( $do_timeleft ? human_time_diff( $offset ) : date_i18n( $this->get_date_format(), $offset ) ),
