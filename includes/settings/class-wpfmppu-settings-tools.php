...
if ( ! class_exists( 'WPFMPPU_Settings_Tools' ) ) :

class WPFMPPU_Settings_Tools extends WPFMPPU_Settings_Section {
		...
		$tools_settings = array(
			...
			array(
				...
				'desc_tip' => __( 'The maximum execution time, in seconds.', 'maximum-products-per-user-for-woocommerce' ) . ' ' .
					...
					sprintf(
						/* Translators: %s: Server time limit. */
						__( 'If set to minus one, server time limit (%s seconds) is used.', 'maximum-products-per-user-for-woocommerce' ),
			...
			array(
				...
				'options'  => array(
					'wp_query'      => sprintf(
						...
						__( 'WordPress standard (%s)', 'maximum-products-per-user-for-woocommerce' ),
						'WP_Query'
					),
					'wc_get_orders' => sprintf(
						/* Translators: %s: wc_get_orders. */
						__( 'WooCommerce specific (%s)', 'maximum-products-per-user-for-woocommerce' ),
						'wc_get_orders'
					),
				),
			),
...
return new WPFMPPU_Settings_Tools();
