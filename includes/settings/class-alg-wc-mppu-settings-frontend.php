	...
	function get_settings() {
		...
		$frontend_settings = array(
			...
			array(
				...
				'desc_tip'        => __( 'You can use HTML and/or shortcodes here.', 'maximum-products-per-user-for-woocommerce' ) . ' ' .
				                     sprintf( __( 'E.g.: %s.', 'maximum-products-per-user-for-woocommerce' ), '<em>[alg_wc_mppu_translate]</em>' ) . '<br />' .
				                     sprintf( __( 'You can use %s parameter as %s on %s shortcode in order to get tags.', 'maximum-products-per-user-for-woocommerce' ), '<strong>' . 'taxonomy' . '</strong>', '<strong>' . 'product_tag' . '</strong>', '<strong>' . '[alg_wc_mppu_user_terms_limits]' . '</strong>' ),
				'desc'            => __( 'Useful shortcodes:', 'maximum-products-per-user-for-woocommerce' ) . ' ' . $this->convert_array_to_string( array(
