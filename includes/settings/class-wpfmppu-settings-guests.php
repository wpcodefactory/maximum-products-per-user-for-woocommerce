...
if ( ! class_exists( 'WPFMPPU_Settings_Guests' ) ) :

	class WPFMPPU_Settings_Guests extends WPFMPPU_Settings_Section {
			...
			$block_guest_from_buying_product_opts = array(
				array(
					...
					'desc'  => sprintf(
						...
						__( 'This whole section will only make sense if %1$s option is set as %2$s.', 'maximum-products-per-user-for-woocommerce' ),
						'<strong>' . __( 'Guests', 'maximum-products-per-user-for-woocommerce' ) . '</strong>',
						'<strong>' . __( 'Block guests from buying products', 'maximum-products-per-user-for-woocommerce' ) . '</strong>'
					),
				...
				array(
					...
					'desc_tip'          => sprintf(
							...
							__( 'Choose "%s" if you want to block guests from buying specific products.', 'maximum-products-per-user-for-woocommerce' ),
							__( 'According to limit options', 'maximum-products-per-user-for-woocommerce' )
						) . '<br />' .
						sprintf(
							/* Translators: %1$s: Option name, %2$s: Option name, %3$s: Option name. */
							__( 'In that case it will be necessary to enable the %1$s option on the product or taxonomy page after activating %2$s or %3$s options.', 'maximum-products-per-user-for-woocommerce' ),
							'"' . __( 'Block guests', 'maximum-products-per-user-for-woocommerce' ) . '"',
							'"' . __( 'Per product', 'maximum-products-per-user-for-woocommerce' ) . '"',
							'"' . __( 'Per product taxonomy', 'maximum-products-per-user-for-woocommerce' ) . '"'
						),
				...
				array(
					...
					'default'  => sprintf(
						/* Translators: %s: URL. */
						'<a href="%s" class="button wc-forward">' . __( 'Login', 'maximum-products-per-user-for-woocommerce' ) . '</a>',
...
return new WPFMPPU_Settings_Guests();
