...
if ( ! class_exists( 'WPFMPPU_Settings_Limits' ) ) :

class WPFMPPU_Settings_Limits extends WPFMPPU_Settings_Section {
	...
	function get_settings() {
		...
		if ( 'yes' === get_option( 'alg_wc_mppu_use_user_roles', 'no' ) ) {
			foreach ( wpfmppu()->core->get_user_roles() as $role => $role_name ) {
...
return new WPFMPPU_Settings_Limits();
