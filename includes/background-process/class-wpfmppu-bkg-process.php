...
if ( ! class_exists( 'WPFMPPU_Bkg_Process' ) ) :

	class WPFMPPU_Bkg_Process extends WPFMPPU_DeliciousBrains_Background_Process {
		...
		public function get_email_params() {
			$params = wp_parse_args( apply_filters( 'wpfmppu_bkg_process_email_params', $this->email_sending_params ), array(
