...
/**
 * Abstract Alg_WC_MPPU_DeliciousBrains_Background_Process class.
 *
 * @abstract
 * @extends Alg_WC_MPPU_DeliciousBrains_Async_Request
 */
abstract class Alg_WC_MPPU_DeliciousBrains_Background_Process extends Alg_WC_MPPU_DeliciousBrains_Async_Request {
	/**
