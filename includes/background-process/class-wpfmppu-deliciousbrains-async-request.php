...
/**
 * Abstract WPFMPPU_DeliciousBrains_Async_Request class.
 *
 * @abstract
 */
abstract class WPFMPPU_DeliciousBrains_Async_Request {
	...
	protected function get_query_args() {
		 ...
		 * @param array $args
		 */
		return apply_filters( $this->identifier . '_query_args', $args ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.DynamicHooknameFound
	}
	...
	protected function get_query_url() {
		 ...
		 * @param string $url
		 */
		return apply_filters( $this->identifier . '_query_url', $url ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.DynamicHooknameFound
	}
	...
	protected function get_post_args() {
		 ...
		 * @param array $args
		 */
		return apply_filters( $this->identifier . '_post_args', $args ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.DynamicHooknameFound
	}
